...
#define INTERNET_STATUS_COOKIE_STATE            322
#define INTERNET_STATUS_COOKIE_SUPPRESSED       323
...
typedef enum
{
	...
	COOKIE_STATE_REJECT         = 0x2,
	COOKIE_STATE_NO_POLICY      = 0x3,
	COOKIE_STATE_POLICY_ERROR   = 0x4,
	COOKIE_STATE_EVAL_ERROR     = 0x5,
	COOKIE_STATE_PROMPT         = 0x6,
	COOKIE_STATE_BLOCK          = 0x10,
}
InternetCookieState;
#else
typedef enum
...
typedef struct _INTERNET_CACHE_ENTRY_INFOA
{
	...
	union
	{					  // Exemption delta from last access time.
		DWORD dwReserved;
		DWORD dwExemptDelta;
