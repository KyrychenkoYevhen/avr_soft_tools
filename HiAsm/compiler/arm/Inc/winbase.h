...
extern BOOL ResourceCreateList (DWORD dwResId, DWORD dwMinimum, DWORD dwCount);
extern BOOL ResourceRequest (DWORD dwResId, DWORD dwId, DWORD dwLen);
extern BOOL ResourceRelease (DWORD dwResId, DWORD dwId, DWORD dwLen);
