...
/* Define _CRTAPI1 (for compatibility with the Microsoft Windows NT SDK) */
#ifndef _CRTAPI1
...
/* Define _CRTAPI2 (for compatibility with the Microsoft Windows NT SDK) */
#ifndef _CRTAPI2
#if     _MSC_VER >= 800 && _M_IX86 >= 300
...
#if (defined(_M_SH) && _M_SH == 5)
#define _INTRIMP    /* new intrinsic function - don't import */
#else
#define _INTRIMP  _CRTIMP  /* not intrinsic function */
#endif
...
_INTRIMP void * __cdecl memchr(const void *, int, size_t);
...
#ifdef  _M_SH
#define _MCW_DN     0x00040000      /* Denormal Control (SH4, SH5compact)   */
#define _DN_FLUSH   0x00040000      /*   flush to zero  (SH4, SH5compact)   */
#else
...
#elif   defined(_M_SH) && (_M_SH == 5)

#define _INTSIZEOF(n)   ( (sizeof(n) + sizeof(__int64) - 1) & ~(sizeof(__int64) - 1) )
#define va_start(ap,v)  ( ap = (va_list)&v + _INTSIZEOF(v) )
#define va_arg(ap,t)    ( *(t *)((ap += _INTSIZEOF(t)) - _INTSIZEOF(t)) )
#define va_end(ap)      ( ap = (va_list)0 )

#elif defined(_M_AM) || defined(_M_TRICORE) || defined(_M_M32R) || defined(SHx)
...
extern  "C" void __cdecl __va_start(va_list*, ...);
#define va_start(ap,v) (__va_start(&ap, &v, _INTSIZEOF(v)))
...
#elif defined(SHx) || defined(MIPS) || defined(_M_M32R) || defined(_M_AM)

#define _JBLEN        32

#elif defined(_M_SH) && (_M_SH == 5)

// SH5 Jump Buffer Size:
// Permanent 32-bit General Registers: R10-R15                 24bytes   0 -  18
// Permanent 64-bit GPR:               R16                      8bytes  18 -  20
// Permanent 32-bit                    R18, vfp note            8bytes  20 -  28
// Permanent 64-bit GPR:               R24-R35                 96bytes  28 -  88
// Permanent 64-bit GPR:               R44-R59                128bytes  88 - 108
// Permanent 32-bit FP Registers:      FR12-FR15,FR36-FR63    128bytes 108 - 188
// Permanent 32-bit Target Registers:  TR5-TR7                 12bytes 188 - 194
// 4 bytes padding                                              4bytes 194 - 198
// Permanent 64-bit Status Registers:  SR,USR                  16bytes 198 - 1a8
// ------------------------------------------------------------------------------------------------
// Total                                                      424bytes
