...
#elif defined(_M_PPC) || defined(SHx) || defined(ARM) || defined(_M_CEE)
...
#define CONTEXT_DSP_REGISTERS	(CONTEXT_SH3 | 0x00000010L)
#define CONTEXT_FULL (CONTEXT_CONTROL | CONTEXT_INTEGER | CONTEXT_DEBUG_REGISTERS | CONTEXT_DSP_REGISTERS)
#else	// SH4
