...
const
  ...
  MAXERRORLENGTH   = {$ifdef UNICODE}256{$else}128{$endif};    { max error text length (including nil) }
...
type
  ...
  tagWAVEOUTCAPS = {$ifdef UNICODE}tagWAVEOUTCAPSW{$else}tagWAVEOUTCAPSA{$endif};
...
type
  ...
  tagWAVEINCAPS = {$ifdef UNICODE}tagWAVEINCAPSW{$else}tagWAVEINCAPSA{$endif};
...
type
  ...
  tagMIDIOUTCAPS = {$ifdef UNICODE}tagMIDIOUTCAPSW{$else}tagMIDIOUTCAPSA{$endif};
...
type
  ...
  tagMIDIINCAPS = {$ifdef UNICODE}tagMIDIINCAPSW{$else}tagMIDIINCAPSA{$endif};
...
function midiStreamOpen(phms: PHMIDISTRM; puDeviceID: PUINT;
  cMidi, dwCallback, dwInstance: DWORD_PTR; fdwOpen: DWORD): MMRESULT; stdcall;
...
type
  ...
  tagAUXCAPS = {$ifdef UNICODE}tagAUXCAPSW{$else}tagAUXCAPSA{$endif};
...
type
  ...
  tagMIXERCAPS = {$ifdef UNICODE}tagMIXERCAPSW{$else}tagMIXERCAPSA{$endif};
...
function mixerOpen(phmx: PHMIXER; uMxId: UINT; dwCallback, dwInstance: DWORD_PTR; fdwOpen: DWORD): MMRESULT; stdcall;
...
type
  ...
  tagMIXERLINE = {$ifdef UNICODE}tagMIXERLINEW{$else}tagMIXERLINEA{$endif};
...
type
  ...
  tagMIXERCONTROL = {$ifdef UNICODE}tagMIXERCONTROLA{$else}tagMIXERCONTROLA{$endif};
...
type
  ...
  tagMIXERLINECONTROLS = {$ifdef UNICODE}tagMIXERLINECONTROLSW{$else}tagMIXERLINECONTROLSA{$endif};
...
type
  ...
  tMIXERCONTROLDETAILS = record
    ...
    // NOTE: Only hwndOwner and cMultipleItems are in the actual union.
    case Integer of
  ...
  tagMIXERCONTROLDETAILS_LISTTEXT = {$ifdef UNICODE}tagMIXERCONTROLDETAILS_LISTTEXTW{$else}tagMIXERCONTROLDETAILS_LISTTEXTA{$endif};
...
type
  ...
  tagJOYCAPS = {$ifdef UNICODE}tagJOYCAPSW{$else}tagJOYCAPSA{$endif};
...
type
  ...
  tagMCI_OPEN_PARMS = {$ifdef UNICODE}tagMCI_OPEN_PARMSW{$else}tagMCI_OPEN_PARMSA{$endif};
...
type
  ...
  tagMCI_INFO_PARMS = {$ifdef UNICODE}tagMCI_INFO_PARMSW{$else}tagMCI_INFO_PARMSA{$endif};
...
type
  ...
  tagMCI_SYSINFO_PARMS = {$ifdef UNICODE}tagMCI_SYSINFO_PARMSW{$else}tagMCI_SYSINFO_PARMSA{$endif};
...
type
  ...
  MCI_SAVE_PARMS = {$ifdef UNICODE}MCI_SAVE_PARMSW{$else}MCI_SAVE_PARMSA{$endif};
...
type
  ...
  tagMCI_LOAD_PARMS = {$ifdef UNICODE}tagMCI_LOAD_PARMSW{$else}tagMCI_LOAD_PARMSA{$endif};
...
type
  ...
  tagMCI_VD_ESCAPE_PARMS = {$ifdef UNICODE}tagMCI_VD_ESCAPE_PARMSW{$else}tagMCI_VD_ESCAPE_PARMSA{$endif};
...
type
  ...
  tagMCI_WAVE_OPEN_PARMS = {$ifdef UNICODE}tagMCI_WAVE_OPEN_PARMSW{$else}tagMCI_WAVE_OPEN_PARMSA{$endif};
...
type
  ...
  tagMCI_ANIM_OPEN_PARMS = {$ifdef UNICODE}tagMCI_ANIM_OPEN_PARMSW{$else}tagMCI_ANIM_OPEN_PARMSA{$endif};
...
type
  ...
  tagMCI_ANIM_WINDOW_PARMS = {$ifdef UNICODE}tagMCI_ANIM_WINDOW_PARMSW{$else}tagMCI_ANIM_WINDOW_PARMSA{$endif};
...
type
  ...
  tagMCI_OVLY_OPEN_PARMS = {$ifdef UNICODE}tagMCI_OVLY_OPEN_PARMSW{$else}tagMCI_OVLY_OPEN_PARMSA{$endif};
...
type
  ...
  tagMCI_OVLY_WINDOW_PARMS = {$ifdef UNICODE}tagMCI_OVLY_WINDOW_PARMSW{$else}tagMCI_OVLY_WINDOW_PARMSA{$endif};
...
type
  ...
  tagMCI_OVLY_SAVE_PARMS = {$ifdef UNICODE}tagMCI_OVLY_SAVE_PARMSW{$else}tagMCI_OVLY_SAVE_PARMSA{$endif};
...
type
  ...
  tagMCI_OVLY_LOAD_PARMS = {$ifdef UNICODE}tagMCI_OVLY_LOAD_PARMSW{$else}tagMCI_OVLY_LOAD_PARMSA{$endif};
...
function auxGetDevCaps; external mmsyst name {$ifdef UNICODE}'auxGetDevCapsW'{$else}'auxGetDevCapsA'{$endif};
...
function joyGetDevCaps; external mmsyst name {$ifdef UNICODE}'joyGetDevCapsW'{$else}'joyGetDevCapsA'{$endif};
...
function mciGetDeviceID; external mmsyst name {$ifdef UNICODE}'mciGetDeviceIDW'{$else}'mciGetDeviceIDA'{$endif};
{
...
function mciGetErrorString; external mmsyst name {$ifdef UNICODE}'mciGetErrorStringW'{$else}'mciGetErrorStringA'{$endif};
...
function mciSendCommand; external mmsyst name {$ifdef UNICODE}'mciSendCommandW'{$else}'mciSendCommandA'{$endif};
function mciSendStringA; external mmsyst name 'mciSendStringA';
function mciSendStringW; external mmsyst name 'mciSendStringW';
function mciSendString; external mmsyst name {$ifdef UNICODE}'mciSendStringW'{$else}'mciSendStringA'{$endif};
...
function midiInGetDevCaps; external mmsyst name {$ifdef UNICODE}'midiInGetDevCapsW'{$else}'midiInGetDevCapsA'{$endif};
...
function midiInGetErrorText; external mmsyst name {$ifdef UNICODE}'midiInGetErrorTextW'{$else}'midiInGetErrorTextA'{$endif};
...
function midiOutGetDevCaps; external mmsyst name {$ifdef UNICODE}'midiOutGetDevCapsW'{$else}'midiOutGetDevCapsA'{$endif};
...
function midiOutGetErrorText; external mmsyst name {$ifdef UNICODE}'midiOutGetErrorTextW'{$else}'midiOutGetErrorTextA'{$endif};
...
function mixerGetControlDetails; external mmsyst name {$ifdef UNICODE}'mixerGetControlDetailsW'{$else}'mixerGetControlDetailsA'{$endif};
...
function mixerGetDevCaps; external mmsyst name {$ifdef UNICODE}'mixerGetDevCapsW'{$else}'mixerGetDevCapsA'{$endif};
...
function mixerGetLineControls; external mmsyst name {$ifdef UNICODE}'mixerGetLineControlsW'{$else}'mixerGetLineControlsA'{$endif};
...
function mixerGetLineInfo; external mmsyst name {$ifdef UNICODE}'mixerGetLineInfoW'{$else}'mixerGetLineInfoA'{$endif};
...
function mmioInstallIOProc; external mmsyst name {$ifdef UNICODE}'mmioInstallIOProcW'{$else}'mmioInstallIOProcA'{$endif};
function mmioOpenA; external mmsyst name 'mmioOpenA';
function mmioOpenW; external mmsyst name 'mmioOpenW';
function mmioOpen; external mmsyst name {$ifdef UNICODE}'mmioOpenW'{$else}'mmioOpenA'{$endif};
...
function mmioRename; external mmsyst name {$ifdef UNICODE}'mmioRenameW'{$else}'mmioRenameA'{$endif};
...
function mmioStringToFOURCC; external mmsyst name {$ifdef UNICODE}'mmioStringToFOURCCW'{$else}'mmioStringToFOURCCA'{$endif};
...
function PlaySound; external mmsyst name {$ifdef UNICODE}'PlaySoundW'{$else}'PlaySoundA'{$endif};
...
function sndPlaySound; external mmsyst name {$ifdef UNICODE}'sndPlaySoundW'{$else}'sndPlaySoundA'{$endif};
...
function waveInGetDevCaps; external mmsyst name {$ifdef UNICODE}'waveInGetDevCapsW'{$else}'waveInGetDevCapsA'{$endif};
...
function waveInGetErrorText; external mmsyst name {$ifdef UNICODE}'waveInGetErrorTextW'{$else}'waveInGetErrorTextA'{$endif};
...
function waveOutGetDevCaps; external mmsyst name {$ifdef UNICODE}'waveOutGetDevCapsW'{$else}'waveOutGetDevCapsA'{$endif};
...
function waveOutGetErrorText; external mmsyst name {$ifdef UNICODE}'waveOutGetErrorTextW'{$else}'waveOutGetErrorTextA'{$endif};
