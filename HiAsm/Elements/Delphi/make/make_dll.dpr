...
function buildMakePrj(var params:TBuildMakePrjRec):integer; cdecl;
var Res:PStrList;
    Header:PStrList;
    i:integer;
    P:PCGrec;
begin
   ...
   Res.Add('{$I share.inc}');
   Res.Add('{$ifdef FPC} {$SMARTLINK OFF} {$endif}');
   ...
   Res.Add('end;');
   Res.Add('');
   Res.Add('procedure _hi_PointsInfo(var _prop_WorkPoints,_prop_EventPoints,_prop_VarPoints,_prop_DataPoints:PChar); export;');
   Res.Add('begin');
   ...
   Res.Add('end;');
   Res.Add('');
   Res.Add('procedure _hi_Icon(var _prop_Icon:cardinal); export;');
   Res.Add('begin');
    for i := 0 to Header.Count-1 do
...
function buildCompliteProc(var params:TBuildCompliteRec):integer; cdecl;
var src:string;
begin
