...
begin
  case Code of
    24  :  Result := 'Россия';
	  123 :  Result := 'Австралия';
	  40  :  Result := 'Австрия';
	  81  :  Result := 'Азербайджан';
	  82  :  Result := 'Армения';
	  340 :  Result := 'Белоруссия';
	  38  :  Result := 'Бельгия';
	  41  :  Result := 'Болгария';
	  45  :  Result := 'Великобритания';
	  44  :  Result := 'Венгрия';
	  46  :  Result := 'Германия';
	  48  :  Result := 'Греция';
	  83  :  Result := 'Грузия';
	  ...
	  138 :  Result := 'Канада';
	  107 :  Result := 'Кипр';
	  92  :  Result := 'Киргизия (Кыргызстан)';
	  76  :  Result := 'Китай';
	  29  :  Result := 'Корея (КНДР)';
	  108 :  Result := 'Корея, республика';
	  53  :  Result := 'Латвия';
	  54  :  Result := 'Литва';
	  59  :  Result := 'Молдавия';
	  60  :  Result := 'Нидерланды';
	  130 :  Result := 'Новая Зеландия';
	  61  :  Result := 'Норвегия';
	  62  :  Result := 'Польша';
	  35  :  Result := 'Португалия';
	  63  :  Result := 'Румыния';
	  139 :  Result := 'США';
	  74  :  Result := 'Сербия и Черногория';
	  65  :  Result := 'Словакия';
	  66  :  Result := 'Словения';
	  91  :  Result := 'Таджикистан';
	  90  :  Result := 'Туркмения';
	  77  :  Result := 'Турция';
	  93  :  Result := 'Узбекистан';
	  39  :  Result := 'Украина';
	  68  :  Result := 'Финляндия';
	  37  :  Result := 'Франция';
	  69  :  Result := 'Хорватия';
