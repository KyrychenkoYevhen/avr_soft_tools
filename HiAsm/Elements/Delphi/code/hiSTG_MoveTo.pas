...
begin
  ...
  FFileName := WideString(ReadString(_Data, _data_InPath));
  FNewFileName := WideString(ReadString(_Data, _data_InMoveToPath));
  ...
  begin
    ...
    tmpPath := WideString(Time2StrFmt(Date2StrFmt(TMPFILEFORMAT, DateTime), DateTime));
