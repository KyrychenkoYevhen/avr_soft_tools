...
//Abulafia:
//{$DEFINE RegExprUseExceptions}
//{$DEFINE RegExprUseTStringSplitting}
{$IFNDEF KOL3XX}
{$DEFINE RegExprUseOwnStrFuncs}
{$ENDIF}
...
{$IFDEF RegExprUseExceptions}
  {$DEFINF UseSomeUnits}
{$ENDIF}

{$IFDEF RegExprUseTStringSplitting}
  {$DEFINF UseSomeUnits}
{$ENDIF}
...
uses
  ...
  {$ifdef KOL3XX}, KOL{$endif};

{$IFDEF RegExprUseOwnStrFuncs}
