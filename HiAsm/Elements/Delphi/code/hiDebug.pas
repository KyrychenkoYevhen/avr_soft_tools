...
type
  THIDebug = class(TDebug)
   private
    ...
    CounterVD:cardinal;
    CounterUp:cardinal;
    logWE,logVD,logUp:PKOLStrList;

    procedure SetEnabled(const Value:boolean);
    procedure Blink(var dt:TData; Ind:smallint; var Cnt:cardinal; list:PKOLStrList);
    ...
    case Bar.CurIndex of
      ...
      1: 
        if(List.LVCurItem <> -1)and(List.LVItemData[List.LVCurItem] > 0)then
         begin
          lst := PKOLStrList(List.LVItemData[List.LVCurItem]);    
