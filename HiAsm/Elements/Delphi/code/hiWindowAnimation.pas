...
type
  ...
  private
    ...
    function AnimateAppearThread (Sender:PThread):NativeInt;
    function AnimateDisappearThread (Sender:PThread):NativeInt;
...
function THIWindowAnimation.AnimateAppearThread (Sender:PThread):NativeInt;
begin
  AnimateAppear;
  FThread.Synchronize(GenerateEvent);
end;

function THIWindowAnimation.AnimateDisappearThread (Sender:PThread):NativeInt;
begin
  AnimateDisappear;
  FThread.Synchronize(GenerateEvent);
end;
