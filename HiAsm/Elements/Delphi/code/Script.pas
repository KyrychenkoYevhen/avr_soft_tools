...
type
  ...
  TScript = class
    private
      ...
      procedure AddError(Error:string; Next:boolean = false);
      procedure Start;
    ...
    public
      ...
      constructor Create;
      destructor Destroy; override;
      procedure Build(List:PKOLStrList;var Error:PKOLStrList);
      procedure BuildFromText(var Err:PKOLStrList);
      ...
      procedure ScriptDebug(List:PKOLStrList);
  end;
...
procedure TScript.ScriptDebug(List:PKOLStrList);
