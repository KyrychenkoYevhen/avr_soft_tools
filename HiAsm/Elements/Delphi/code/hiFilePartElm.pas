...
function GetLongPathName(lpszShortName: PChar; lpszLongName: PChar;
         cchBuffer: DWORD): DWORD; stdcall; external 'kernel32.dll' name {$ifdef UNICODE}'GetLongPathNameW'{$else}'GetLongPathNameA'{$endif};
