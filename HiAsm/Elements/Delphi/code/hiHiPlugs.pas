...
begin
   doWork(Param.ID,Share.ToString(_Data),0);
end;

procedure THIhiPlugs._work_doOpen;
begin
   doWork(Param.ID,Share.ToString(_Data),1);
end;

procedure THIhiPlugs._work_doInterface;
begin
   doWork(Param.ID,Share.ToString(_Data),2);
end;

procedure THIhiPlugs._work_doChat;
begin
   doWork(Param.ID,Share.ToString(_Data),3);
end;

procedure THIhiPlugs._work_doCommand;
begin
   doWork(Param.ID,Share.ToString(_Data),4);
end;

procedure THIhiPlugs._work_doCmdEnabled;
begin
   doWork(Param.ID,Share.ToString(_Data),5);
end;

procedure THIhiPlugs._work_doRegPanel;
begin
   doWork(Param.ID,Share.ToString(_Data),6);
end;

procedure THIhiPlugs._work_doCmdUpdate;
begin
   doWork(Param.ID,Share.ToString(_Data),7);
end;
