...
function WndProcUpDown(Sender: PControl; var Msg: TMsg; var Rslt: LRESULT): Boolean;
var   UD: THIUpDown;
      NMUpDown: PNMUpDown;
      Allow: Boolean;
...
function WndProcUpDownParent(Sender: PControl; var Msg: TMsg; var Rslt: LRESULT): Boolean;
var   UD: THIUpDown;
begin
   Result := FALSE;
