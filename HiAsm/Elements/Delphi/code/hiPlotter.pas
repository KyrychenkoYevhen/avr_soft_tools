...
//    onChangeSeries:TEvents;
  ...
  THIPlotter = class(THIWin)
   ...
   public
    ...
    procedure _work_doGridX(var _Data:TData; Index:word);
    procedure _work_doGridY(var _Data:TData; Index:word);
...
//      Pen.PenStyle := psDot;
      Pen.PenStyle := TPenStyle(_prop_GridStyle);
...
procedure THIPlotter._work_doGridX;
begin
  _prop_GridX := ToInteger(_Data);
  ReDraw;
end;

procedure THIPlotter._work_doGridY;
begin
  _prop_GridY := ToInteger(_Data);
  ReDraw;
end;

procedure THIPlotter._var_Bitmap;
begin
  dtBitmap(_Data,Bmp);
end;
