...
type
  THIPC_Text = class(TPrintController)
   ...
   public
    ...
    procedure _work_doSharpenApply(var _Data:TData; Index:word);
    procedure _work_doSharpen(var _Data:TData; Index:word);
...
begin
  ...
  if _prop_SharpenApply then
    THIPrint_Text(FItem)._prop_Sharpen := _prop_Sharpen;
...
procedure THIPC_Text._work_doSharpenApply;
begin
  _prop_SharpenApply := ReadBool(_Data);
end;

procedure THIPC_Text._work_doSharpen;
begin
  _prop_Sharpen := ToInteger(_Data);
end;
