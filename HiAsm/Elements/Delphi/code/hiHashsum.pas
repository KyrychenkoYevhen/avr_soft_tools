...
begin
   ...
   case dt.Data_type of
    data_str,data_int,data_real: Res := MD5DigestToStr( MD5String(Share.ToString(dt)) );
    data_stream:
...
begin
   dt := ReadData(_Data,_data_Data,nil);
   case dt.Data_type of
    data_str,data_int,data_real: HashStr(HASH_SHA1, Share.ToString(dt), Res);
    data_stream:
      if(PStream(dt.idata) <> nil)and(PStream(dt.idata).Size > 0)then
...
begin
   dt := ReadData(_Data,_data_Data,nil);
   case dt.Data_type of
    data_str,data_int,data_real: HashStr(HASH_SHA256, Share.ToString(dt), Res);
    data_stream:
      if(PStream(dt.idata) <> nil)and(PStream(dt.idata).Size > 0)then
...
begin
   dt := ReadData(_Data,_data_Data,nil);
   case dt.Data_type of
    data_str,data_int,data_real: HashStr(HASH_SHA384, Share.ToString(dt), Res);
    data_stream:
      if(PStream(dt.idata) <> nil)and(PStream(dt.idata).Size > 0)then
...
begin
   dt := ReadData(_Data,_data_Data,nil);
   case dt.Data_type of
    data_str,data_int,data_real: HashStr(HASH_SHA512, Share.ToString(dt), Res);
    data_stream:
      if(PStream(dt.idata) <> nil)and(PStream(dt.idata).Size > 0)then
