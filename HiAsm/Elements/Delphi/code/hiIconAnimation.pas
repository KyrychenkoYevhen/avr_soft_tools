...
type
  ThiIconAnimation = class(TDebug)
   private
    ...
    procedure SetIndex(Value:PKOLStrListEx);
    procedure SetBitmap(Value:PKOLStrListEx);    
   ...
   public
    ...
    property _prop_IndexArray  : PKOLStrListEx write SetIndex;    
    property _prop_Bitmaps     : PKOLStrListEx write SetBitmap;
