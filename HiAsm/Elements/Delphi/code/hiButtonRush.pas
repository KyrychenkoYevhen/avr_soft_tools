...
uses Windows,Kol,Share,Win,{$ifdef KOL3XX}KOLGRushControls3{$else}KOLGRushControls{$endif};
...
type
 ThiButtonRush = class(THIWin)
   private
     ...
     procedure SetGlyphs(Value: PKOLStrListEx);
   public
    ...
    _prop_AlphaBlendValue:integer;
     ...
     property _prop_Glyphs: PKOLStrListEx write SetGlyphs;     
