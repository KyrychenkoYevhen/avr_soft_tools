...
type
  ...
  tagPSD = {$ifdef UNICODE}tagPSDW{$else}tagPSDA{$endif};
  PtagPSD = ^tagPSD;


function PageSetupDlg(var PgSetupDialog: tagPSD): BOOL; stdcall;external 'comdlg32.dll' name {$ifdef UNICODE}'PageSetupDlgW'{$else}'PageSetupDlgA'{$endif};
...
begin
    ...
    fDevMode  := PDeviceMode(GlobalLock(ftagPSD.hDevMode));
