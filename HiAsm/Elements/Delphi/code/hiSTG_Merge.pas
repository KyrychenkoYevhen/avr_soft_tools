...
begin
  ...
  src := WideString(ReadString(_Data, _data_MergeSrcStgPath, _prop_MergeSrcStgPath));
  dst := WideString(ReadString(_Data, _data_MergeDstStgPath, _prop_MergeDstStgPath));  
  if (src = '') or (dst = '') then
  begin
