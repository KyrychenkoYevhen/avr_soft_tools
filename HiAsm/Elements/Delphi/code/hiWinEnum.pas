...
begin
   ...
   SetLength(FClassName,GetClassName(FHandle,@FClassname[1],512));
end;
...
begin
  ...
  LstChildWindows := NewKOLStrListEx;
  EnumChildWindows(wndHandle, @MyCallback, NativeUInt(Self));
