...
const
 ...
 DDE_CODEPAGE = {$ifdef UNICODE}CP_WINUNICODE{$else}CP_WINANSI{$endif};
...
{$ifdef UNICODE}
function DdeInitialize; external USER32DLL name 'DdeInitializeW';
function DdeCreateStringHandle; external USER32DLL name 'DdeCreateStringHandleW';
function DdeQueryString; external USER32DLL name 'DdeQueryStringW';
{$else}
function DdeInitialize; external USER32DLL name 'DdeInitializeA';
function DdeCreateStringHandle; external USER32DLL name 'DdeCreateStringHandleA';
function DdeQueryString; external USER32DLL name 'DdeQueryStringA';
{$endif}

function DdeNameService; external USER32DLL name 'DdeNameService'; 
function DdeFreeStringHandle; external USER32DLL name 'DdeFreeStringHandle'; 
function DdeConnect; external USER32DLL name 'DdeConnect';
function DdeClientTransaction; external USER32DLL name 'DdeClientTransaction';
function DdeCreateDataHandle; stdcall; external USER32DLL name 'DdeCreateDataHandle';
function DdeGetData; stdcall; external USER32DLL name 'DdeGetData';  
function DdeFreeDataHandle; external USER32DLL name 'DdeFreeDataHandle';
function DdePostAdvise; stdcall; external USER32DLL name 'DdePostAdvise';
function DdeDisconnect; external USER32DLL name 'DdeDisconnect';  
function DdeUninitialize; external USER32DLL name 'DdeUninitialize';  
