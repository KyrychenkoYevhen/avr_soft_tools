    ...
    begin
      ...
      if length(Text) > 0 then
        begin
          ...
          Windows.{$ifdef UNICODE}DrawTextW{$else}DrawTextA{$endif}(Handle, PChar(Text), Length(Text), r, DT_CALCRECT);
          ...
          Windows.{$ifdef UNICODE}DrawTextW{$else}DrawTextA{$endif}(Handle, PChar(Text), Length(Text), r, 0);
        end; 
    end;
end;
