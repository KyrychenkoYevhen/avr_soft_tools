...
type
  ...
  PPSTR     = ^PChar;
  PHICON    = ^HICON;
  ULONG_PTR = {$ifdef WIN64}UInt64{$else}DWORD{$endif};
  DWORD_PTR = {$ifdef WIN64}UInt64{$else}DWORD{$endif};
  UINT_PTR  = {$ifdef WIN64}UInt64{$else}DWORD{$endif};
...
function SetupDiEnumDeviceInfo(DeviceInfoSet: HDEVINFO; MemberIndex: DWORD;
                               ...
                               stdcall; external SetupApiDLL name 'SetupDiEnumDeviceInfo';
...
function SetupDiGetDeviceRegistryProperty(DeviceInfoSet: HDEVINFO; const DeviceInfoData: TSPDevInfoData;
                                           ...
                                           stdcall; external SetupApiDLL name {$ifdef UNICODE}'SetupDiGetDeviceRegistryPropertyW'{$else}'SetupDiGetDeviceRegistryPropertyA'{$endif};
...
function SetupDiGetClassDescription(var ClassGuid: TGUID; ClassDescription: PChar;
                                     ...
                                     stdcall; external SetupApiDLL name {$ifdef UNICODE}'SetupDiGetClassDescriptionW'{$else}'SetupDiGetClassDescriptionA'{$endif};

function SetupDiGetClassImageList(var ClassImageListData: TSPClassImageListData): LongBool;
                                  stdcall; external SetupApiDLL name 'SetupDiGetClassImageList';

function SetupDiDestroyClassImageList(var ClassImageListData: TSPClassImageListData): LongBool;
                                      stdcall; external SetupApiDLL name 'SetupDiDestroyClassImageList';

function SetupDiGetClassDevsEx(ClassGuid: PGUID; const Enumerator: PChar;
                                hwndParent: HWND; Flags: DWORD; DeviceInfoSet: HDEVINFO;
                                const MachineName: PChar; Reserved: Pointer): HDEVINFO;
                                stdcall; external SetupApiDLL name {$ifdef UNICODE}'SetupDiGetClassDevsExW'{$else}'SetupDiGetClassDevsExA'{$endif};

function SetupDiDestroyDeviceInfoList(DeviceInfoSet: HDEVINFO): LongBool;
                                      stdcall; external SetupApiDLL name 'SetupDiDestroyDeviceInfoList';

function SetupDiCreateDeviceInfoList(ClassGuid: PGUID; hwndParent: HWND): HDEVINFO;
                                     stdcall;  external SetupApiDLL name 'SetupDiCreateDeviceInfoList';
...
function SetupDiGetClassImageIndex(var ClassImageListData: TSPClassImageListData; var ClassGuid: TGUID;
                                   ...
                                   stdcall; external SetupApiDLL name 'SetupDiGetClassImageIndex';
...
function SetupDiSetClassInstallParams(DeviceInfoSet: HDEVINFO; DeviceInfoData: PSPDevInfoData;
                                      ...
                                      stdcall; external SetupApiDLL name {$ifdef UNICODE}'SetupDiSetClassInstallParamsW'{$else}'SetupDiSetClassInstallParamsA'{$endif};

function SetupDiChangeState(DeviceInfoSet: HDEVINFO; var DeviceInfoData: TSPDevInfoData): LongBool;
                            stdcall; external SetupApiDLL name 'SetupDiChangeState';
...
function SetupDiGetDeviceInstanceId(DeviceInfoSet: HDEVINFO; DeviceInfoData: PSPDevInfoData;
                                     ...
                                     stdcall; external SetupApiDLL name {$ifdef UNICODE}'SetupDiGetDeviceInstanceIdW'{$else}'SetupDiGetDeviceInstanceIdA'{$endif};                                                          
...
begin
  case message of
    WM_DEVICECHANGE:
    begin
      MySelf := THiDeviceInfo(Pointer(GetWindowLongPtr(Window, GWLP_USERDATA))); 
...
begin
  ...
  SetWindowLongPtr(ToolWnd, GWLP_USERDATA, NativeInt(Self));
...
begin
  ...
  hAllDevices := SetupDiGetClassDevsEx(nil, nil, 0, dwFlags, nil, nil, nil);
...
//  AddRow('Characteristics', DeviceHelper.Characteristics);
  ...
  if SetupDiGetDeviceInstanceId(hAllDevices, @DeviceInfoData, @DeviceInstanceId[1], MAX_DEVICE_ID_LEN, @BytesReturned) then
