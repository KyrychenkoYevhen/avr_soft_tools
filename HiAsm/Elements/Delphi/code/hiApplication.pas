...
type
  THIApplication = class(TDebug)
   ...
   public
    ...
    procedure _work_doExitCode(var _Data:TData; Index:word);
...
begin
  SetInfo(Share.ToString(_Data));
end;

procedure THIApplication._work_doExitCode;
begin
  ExitCode := ToInteger(_Data);
end;
