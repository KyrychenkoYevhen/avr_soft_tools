...
var
  hDLL:HMODULE; DSM:TDSMEntry; wc:TWndClass; hNotifyWnd:HWND;
...
var ev:TW_EVENT; rc:TW_UINT16;
    ...
    sz:integer; pmem:Pointer; stm:PStream;
begin
...
initialization
  ...
  if hDLL > 0 then begin
    ...
    hNotifyWnd := {$ifdef UNICODE}CreateWindowW{$else}CreateWindow{$endif}(wc.lpszClassName, nil, 0, 0, 0, 0, 0,
      0, 0, hInstance, nil);
