...
{$ifdef FPC_NEW}
function TTextDropTarget.DragEnter(const dataObj: IDataObject; grfKeyState: DWORD; pt: TPoint; var dwEffect: DWORD): HResult; stdcall;
{$else}
...
{$ifdef FPC_NEW}
function TTextDropTarget.DragOver(grfKeyState: DWORD; pt: TPoint; var dwEffect: DWORD): HResult; stdcall;
{$else}
...
{$ifdef FPC_NEW}
function TTextDropTarget.Drop(const dataObj: IDataObject; grfKeyState: DWORD; pt: TPoint; var dwEffect: DWORD): HResult; stdcall;
{$else}
