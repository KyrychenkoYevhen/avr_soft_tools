...
function PickerWndProc(Sender: PControl; var Msg: TMsg; var Rslt: LRESULT): Boolean;
var
...
begin
   ...
   Control.Perform(DTM_SETSYSTEMTIME,GDT_VALID,NativeUInt(@st));
...
var   dt: TDateTime;
      st: TSystemTime;
begin
   Control.Perform(DTM_GETSYSTEMTIME,0,NativeUInt(@st));
