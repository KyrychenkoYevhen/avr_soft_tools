...
type
  THIAlphaBitmap = class(TDebug)
   ...
   public
    ...
    procedure _work_doPremultAlpha(var _Data:TData; Index:word);
    procedure _work_doTransparentColor(var _Data:TData; Index:word);
    procedure _work_doDeleteAlpha(var _Data:TData; Index:word);    
...
begin
  ...
  if _prop_PremultAlpha and not fpma then
  begin
    PremultAlphaTransparent(bmp, _prop_TransparentColor, _prop_DeleteAlpha);
    fpma := true;
  end;  
...
procedure THIAlphaBitmap._work_doPremultAlpha;
begin
  _prop_PremultAlpha := ReadBool(_Data);
end;

procedure THIAlphaBitmap._work_doTransparentColor;
begin
  _prop_TransparentColor := ToInteger(_Data);
end;

procedure THIAlphaBitmap._work_doDeleteAlpha;
begin
  _prop_DeleteAlpha := ReadBool(_Data);
end;
