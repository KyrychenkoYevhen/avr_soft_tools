...
function WndProcScrollBar(Sender: PControl; var Msg: TMsg; var Rslt: LRESULT): Boolean;
...
begin
    ...
    case Msg.message of
      ...
      WM_PAINT:
       Begin
        if PScrollBar(Sender).{$ifdef KOL3XX}DF.fREUpdCount{$else}fUpdCount{$endif}>0 then Exit;
